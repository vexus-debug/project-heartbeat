  ...
  return (
    ...
    >
      ...
      <div className="absolute inset-0 overflow-hidden pointer-events-none">
        ...
        <FloatingElement 
          className="absolute bottom-1/3 right-[8%] text-white/10"
          delay={0.5}
        >
      ...
      <div className="container relative">
        <div className="max-w-4xl mx-auto text-center text-white">
          ...
          >
            {/* Urgency Badge */}
            <motion.div
              className="inline-flex items-center gap-2 bg-white/20 backdrop-blur-sm rounded-full px-4 py-2 text-sm"
            ...
            >
              Ready for Your <br />
              <span className="text-dental-teal-light">Best Smile?</span>
            </motion.h2>
            ...
            >
              Don't wait another day to achieve the smile you deserve. 
              Book your appointment now and let our expert team take care of you.
            </motion.p>
            ...
            >
              <Button 
                asChild 
                size="lg" 
                className="bg-secondary hover:bg-secondary/90 text-secondary-foreground animate-pulse-glow group"
              >
