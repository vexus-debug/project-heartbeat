      ...
      <div className="container relative">
          ...
          {services.map((service, index) => (
            ...
            >
              ...
              <div className="p-6 relative">
                ...
                <Link
                  to={service.href}
                  className="inline-flex items-center text-secondary font-medium text-sm hover:underline group/link"
                >
                  Learn More
        ...
        >
          <Button 
            asChild 
            size="lg" 
            className="bg-secondary hover:bg-secondary/90 animate-pulse-glow group"
          >
            <Link to="/services">
              View All Services
