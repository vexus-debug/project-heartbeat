...
const rotatingWords = ["Beautiful", "Confident", "Radiant", "Perfect", "Healthy"];
          ...
          >
            ...
            >
              <Button 
                asChild 
                size="lg" 
                className="bg-secondary hover:bg-secondary/90 group animate-pulse-glow"
              >
            ...
            >
              ...
              <div className="flex items-center gap-2 bg-card/80 backdrop-blur-sm rounded-full px-4 py-2 shadow-sm">
                ...
                <span className="text-sm font-medium">500+ Happy Patients</span>
              </div>
              <div className="flex items-center gap-2 bg-card/80 backdrop-blur-sm rounded-full px-4 py-2 shadow-sm">
          ...
          >
            <div className="relative">
              ...
              <div className="relative aspect-square max-w-lg mx-auto rounded-3xl overflow-hidden shadow-2xl">
                <img 
                  src={heroImage} 
                  alt="Happy patient with beautiful smile at Vista Dental Care"
