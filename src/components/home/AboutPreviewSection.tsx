        ...
        <div className="grid gap-12 lg:grid-cols-12 items-center">
          ...
          <div className="lg:col-span-5 space-y-6">
            ...
            >
              ...
              <p className="text-foreground italic">
                ...
                and technology, while ensuring patient comfort, safety, and satisfaction."
              </p>
            </motion.div>
          ...
          <div className="lg:col-span-3">
            <div className="grid grid-cols-2 gap-4">
              <StatCard value={500} suffix="+" label="Happy Patients" delay={0.3} isInView={isInView} />
              <div className="pt-8">
                <StatCard value={7} suffix="+" label="Services Offered" delay={0.4} isInView={isInView} />
              </div>
              <StatCard value={5} suffix="+" label="Years Experience" delay={0.5} isInView={isInView} />
              <div className="pt-8">
                <StatCard value={100} suffix="%" label="Patient Satisfaction" delay={0.6} isInView={isInView} />
              </div>
            </div>
          </div>
        </div>
